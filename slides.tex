...
\visible<2->{{\fbox{\tiny\textbf{\textcolor{DarkBlue}{model}} = flicker noise, \textbf{\textcolor{DarkGreen}{mission}} = max throughput with delay $<$ 0.1 s}}}

\item[]

\item[Remy:] Computer-generated protocol design

\visible<3->{{\fbox{\tiny\textbf{\textcolor{DarkBlue}{model}} = user-specified, \textbf{\textcolor{DarkGreen}{mission}} = user-specified}}}

\item[]

\item[Mosh:] Remote terminal app

\visible<4->{{\fbox{\tiny\textbf{\textcolor{DarkBlue}{model}} = ANSI terminal emulator, \textbf{\textcolor{DarkGreen}{mission}} = convey latest frame}}}

\item[]

\item[Alfalfa:] Video streaming app

\visible<5->{{\fbox{\tiny\textbf{\textcolor{DarkBlue}{model}} = VP8 decoder, \textbf{\textcolor{DarkGreen}{mission}} = quality vs.~startup vs.~stalls}}}
